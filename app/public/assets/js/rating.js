  ...
  $(".submitBtn").on("click", function (e) {
    ...
    var settings = {
      "async": true,
      "crossDomain": true,
      "url": `https://faceplusplus-faceplusplus.p.rapidapi.com/facepp/v3/detect?return_attributes=smiling&image_url=${url}`,
      "method": "POST",
      "headers": {
  ...
  $.ajax(settings).done(function (response) {
    console.log(response.faces[0].attributes.smile.value);
